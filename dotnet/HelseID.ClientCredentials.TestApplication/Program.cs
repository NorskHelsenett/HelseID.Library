...
sealed class Program
{
    static void Main(string[] args)
    {
        ...
        var helseIdConfiguration = new HelseIdConfiguration("29a8fc45-1029-485c-8608-e9a3e364468f",
            "e-helse:sfm.api/sfm.api",
            "https://helseid-sts.test.nhn.no");

        builder.Services.AddHelseIdClientCredentials(helseIdConfiguration, jwkPrivateKey);
...
public class TestService : IHostedService
{
    ...
    public TestService(IHelseIdClientCredentialsFlow helseIdClientCredentialsFlow)
    {
