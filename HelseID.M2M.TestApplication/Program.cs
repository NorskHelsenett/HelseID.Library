...
sealed class Program
{
    static void Main(string[] args)
    {
        ...
        builder.Services.AddHelseId(helseIdConfiguration).AddHelseIdSingleTenant().AddInMemoryHelseIdCaching();
